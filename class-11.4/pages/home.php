...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-bs-target="#collapse" data-bs-toggle="collapse">
            ...
            <div class="col-md-8 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-success text-center">This is Card</h3>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <form action="action.php" method="post">
                        <div class="row mb-3">
                            <label for="first_name" class="col-md-3 text-success">First Name</label>
                            <div class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="submit" name="fullName_btn" value="Make Full Name" class="btn btn-success">
                            </div>
                        </div>
                    </form>
                </div>
